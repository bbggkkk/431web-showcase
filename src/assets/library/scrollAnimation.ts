...
export class ScrollAnimationItem {
    element     : HTMLElement;
    animation   : Array<animationValue>|undefined;
    updator     : Function;
    ...
    constructor(element:HTMLElement){
        ...
        this.setLength();
        [this.updator, this.getKeyframe] = createKeyframes(getCSSAttribute((this.element as any).getAttribute('data-animation-bind') ? document.querySelector((this.element as any).getAttribute('data-animation-bind')) : this.element, this.element), this.length);
    }
    ...
    async setAnimationFrame(frame:number){
        if(this.animation !== undefined) {
            ...
            this.getKeyframe(frame).then((data:animationValue) => {
