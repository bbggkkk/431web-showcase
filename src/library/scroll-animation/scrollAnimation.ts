...
export class ScrollAnimationItem {
    ...
    setAttributeValue():void{
        const start = this.element.getAttribute('data-animation-start');
        const end   = this.element.getAttribute('data-animation-end');
        this.scrollStart = isEval(start ? start : document.querySelector(this.element.getAttribute('data-animation-bind')).getAttribute('data-animation-start') , this.element);
        this.scrollEnd   = isEval(end ? end : document.querySelector(this.element.getAttribute('data-animation-bind')).getAttribute('data-animation-end'), this.element);
    }
    setLength():void {
        this.length      = () => {
